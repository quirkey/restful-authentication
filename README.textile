...
* --shoulda: Generates Test::Unit tests in the Shoulda format. Requires "shoulda":http://github.com/thoughtbot/shoulda installed as a plugin or gem.

* --email: Uses #email as the unique identifier for login instead of login
